...
function detectLocales(localesDir) {
  ...
  return fs.readdirSync(localesDir).filter(f => f.endsWith(".json")).map(f => f.replace(".json", ""));
}
/**
...
export { deepMerge, i18nExcelPlugin as default, i18nExcelPlugin, jsonToExcel, parseExcel };
